...
| :-: | :-: |
|강한 관계|약한 관계|
|부모 엔터터의 식별자가 <br/>자식 엔터티의 **<span style="color:#ff6600">주식별자</span>**|부모 엔터티의 식별자가 <br/> 자식 엔터티의 **<span style="color:#ff6600">일반속성</span>**|
|부모 엔터티 필수|부모 엔터티 없는 자식 엔터티 생성 가능|
|실선|점선|
...
> 
> - **<span style="color:#ff6600">비식별 관계는 강한 개체의 기본키를 다른 엔터티의 기본키가 아닌 일반 칼럼으로 관계를 가지는 것</span>**이다.
> 
